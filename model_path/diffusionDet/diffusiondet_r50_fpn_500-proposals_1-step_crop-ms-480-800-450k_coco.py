...
default_hooks = dict(
    ...
    visualization=dict(
        _scope_='mmdet',
        draw=True,
        test_out_dir='/data/output_diffusionDet_2024.7.22/show_usetools_new/',
...
launcher = 'none'
load_from = '/home/gsw/mmdetection/work_dirs/diffusiondet_r50_fpn_500-proposals_1-step_crop-ms-480-800-450k_coco/iter_45000.pth'
log_level = 'INFO'
log_processor = dict(
...
train_cfg = dict(max_iters=45000, type='IterBasedTrainLoop', val_interval=7500)
...
work_dir = './work_dirs/diffusiondet_r50_fpn_500-proposals_1-step_crop-ms-480-800-450k_coco'
