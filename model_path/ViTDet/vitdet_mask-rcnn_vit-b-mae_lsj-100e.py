...
data_root = '/home/caiyiren/mmdetection-3.3.0/data/coco_railway3/'
...
default_hooks = dict(
    ...
    visualization=dict(
        draw=True, test_out_dir='test_hat_result',
...
interval = 5000
launcher = 'none'
load_from = 'work_dirs/vitdet_mask-rcnn_vit-b-mae_lsj-100e/iter_184375.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file=
    '/home/caiyiren/mmdetection-3.3.0/data/coco_railway3/annotations/instances_val2017.json',
    format_only=False,
    metric=[
        'bbox',
        'segm',
