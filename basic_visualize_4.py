...
class Ui_ShangYi(object):
    def setupUi(self, ShangYi):
        ...
        self.b1.setGeometry(QtCore.QRect(10, 180, 100, 45))
        icon1 = QtGui.QIcon()
        ...
        self.b2.setGeometry(QtCore.QRect(10, 300, 100, 45))
        icon2 = QtGui.QIcon()
        ...
        self.b4.setGeometry(QtCore.QRect(10, 420, 100, 45))
        icon3 = QtGui.QIcon()
        ...
        self.b3.setGeometry(QtCore.QRect(10, 540, 100, 45))
        icon4 = QtGui.QIcon()
        ...
        self.b5.setGeometry(QtCore.QRect(10, 660, 100, 45))
        icon5 = QtGui.QIcon()
        ...
        self.b8.setGeometry(QtCore.QRect(10, 780, 100, 45))
        icon8 = QtGui.QIcon()
        ...
        self.static_detection_process = subprocess.Popen(['python','tools/static_interference.py'],stdin=subprocess.PIPE,stdout=subprocess.PIPE)#创建检测进程
        atexit.register(self.detection_process.kill)
        atexit.register(self.static_detection_process.kill)
    ...
    def retranslateUi(self, ShangYi):
        ...
        self.b4.clicked.connect(self.graphicsView.slotrectSignal)
        self.b3.clicked.connect(self.update_lable)
